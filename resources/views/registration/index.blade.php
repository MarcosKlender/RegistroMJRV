            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-col md:flex-row md:justify-between md:items-center mx-auto">
                        ...
                        <div class="basis-2/4 flex items-center p-4 text-sm text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 dark:border-yellow-800"
                            role="alert">
                            ...
                            <div>
                                <span class="font-medium">Recuerda: Debes ingresar las cédulas de los MJRV que se
                                    encuentran en mesa.</span>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr
                                            ...
                                            <td class="flex flex-row items-center px-6 py-4 dark:text-white">
                                                ...
                                                <button type="button" data-modal-target="editModal"
                                                    ...
                                                    data-id="{{ $member->id }}" data-junta="{{ $member->junta }}"
                                                    data-sexo="{{ $member->sexo }}">
                                                ...
                                                <form action="{{ route('registration.update', $member) }}"
                                                    method="POST" class="text-red-400">
                                                    @method('PUT')
                                                    @csrf
                    ...
                    @include('registration._editmodal')
